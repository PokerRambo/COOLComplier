...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> optional_expressions
    ...
    */
    ...
    optional_expressions :    /* empty */
                         ...
                         | optional_expressions ',' expression /* several expressions */
    ...
    expression   :  OBJECTID ASSIGN expression
                       { $$ = assign($1, $3); }
                 |  expression '.' OBJECTID '(' optional_expressions ')'
                       { $$ = dispatch($1, $3, $5); }
                 |  expression '@' TYPEID '.' OBJECTID '(' optional_expressions ')'
                       { $$ = static_dispatch($1, $3, $5, $7); }
                 |  OBJECTID '(' optional_expressions ')'
